...
grant select on app_public.workspace_tag to fundamental_anonymous, fundamental_master;
grant insert on app_public.workspace_tag to fundamental_anonymous, fundamental_master;
grant update(is_enabled) on app_public.workspace_tag to fundamental_anonymous, fundamental_master;
grant delete on app_public.workspace_tag to fundamental_anonymous, fundamental_master;
