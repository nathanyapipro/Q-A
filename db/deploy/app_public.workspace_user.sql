...
grant select on app_public.workspace_user to fundamental_anonymous, fundamental_master;
grant insert on app_public.workspace_user to fundamental_anonymous, fundamental_master;
grant delete on app_public.workspace_user to fundamental_anonymous, fundamental_master;
