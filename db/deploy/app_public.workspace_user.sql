...
grant select on app_public.workspace_user to fundamental_visitor;
grant insert on app_public.workspace_user to fundamental_visitor;
grant delete on app_public.workspace_user to fundamental_visitor;
